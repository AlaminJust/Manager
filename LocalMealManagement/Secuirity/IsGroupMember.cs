...
{
    public class IsGroupMember : AuthorizationHandler<ManageMemberRollAndClaimsRequirment>
    {
        private readonly AppDbContext appDbContext;
        private readonly IHttpContextAccessor _httpContextAccessor;
        public IsGroupMember(AppDbContext appDbContext , IHttpContextAccessor _httpContextAccessor)
        {
            this.appDbContext = appDbContext;
            this._httpContextAccessor = _httpContextAccessor;
        }
        protected override Task HandleRequirementAsync(AuthorizationHandlerContext context, ManageMemberRollAndClaimsRequirment requirement)
        {
